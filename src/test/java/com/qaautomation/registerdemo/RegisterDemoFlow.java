...
public class RegisterDemoFlow {
	...
	String gender = "Male";  // Male or Female or Other
	...
	public void registerDemo() {
		...
		if (cityName.isEnabled()) {
			...
			System.out.println("City Name Value is : " + cityValue);
		} else {
		...
		if (countryDropDown.isEnabled()) {
			...
			System.out.println("Country Drop Down Value is : "+ country);
		...
		if (demoDate.isEnabled()) {
			...
			System.out.println("Date of Demo Value is : " + dateOfDemo);
		...
		if (mobileNum.isEnabled()) {
			...
			System.out.println("Mobile Number Value is : " + mobileNumber);
		} else {
	...
	public void validateSuccessfulMessage() {
		...
		String actualSuccessfulMsgText = successfulMsgText.getText().substring(33);
